...
var G__19301 = cljs.core.first(element_str);
switch (G__19301) {
case "?":
arr.push((1));
...
var G__19323 = cljs.core.next(items);
items = G__19323;
continue;
} else {
return null;
...
var G__19324 = cljs.core.next(items);
items = G__19324;
continue;
} else {
return null;
...
while(true){
if(items){
if(cljs.core.truth_((function (){var G__19318 = cljs.core.first(items);
return (is_valid_QMARK_.cljs$core$IFn$_invoke$arity$1 ? is_valid_QMARK_.cljs$core$IFn$_invoke$arity$1(G__19318) : is_valid_QMARK_.call(null, G__19318));
})())){
var G__19334 = cljs.core.next(cljs.core.next(items));
items = G__19334;
continue;
} else {
return true;
...
switch (G__19321) {
case (0):
if(cljs.core.truth_(oops.schema.has_invalid_path_access_mode_QMARK_(path,(function (p1__19319_SHARP_){
return cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(p1__19319_SHARP_,(2));
})))){
...
break;
case (1):
if(cljs.core.truth_(oops.schema.has_invalid_path_access_mode_QMARK_(path,(function (p1__19320_SHARP_){
return cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(p1__19320_SHARP_,(1));
})))){
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__19321)].join('')));
