shadow$provide.module$node_modules$victory_vendor$lib_vendor$d3_time_format$src$locale = function(global, require, module, exports) {
  ...
  function dISO(d) {
    var day = d.getDay();
    return 4 <= day || 0 === day ? (0,_index.timeThursday)(d) : _index.timeThursday.ceil(d);
  }
  function formatWeekNumberISO(d, p) {
    d = dISO(d);
    return pad(_index.timeThursday.count((0,_index.timeYear)(d), d) + (4 === (0,_index.timeYear)(d).getDay()), p, 2);
  }
  ...
  function formatFullYearISO(d, p) {
    var day = d.getDay();
    d = 4 <= day || 0 === day ? (0,_index.timeThursday)(d) : _index.timeThursday.ceil(d);
    return pad(d.getFullYear() % 10000, p, 4);
  }
  ...
  function UTCdISO(d) {
    var day = d.getUTCDay();
    return 4 <= day || 0 === day ? (0,_index.utcThursday)(d) : _index.utcThursday.ceil(d);
  }
  function formatUTCWeekNumberISO(d, p) {
    d = UTCdISO(d);
    return pad(_index.utcThursday.count((0,_index.utcYear)(d), d) + (4 === (0,_index.utcYear)(d).getUTCDay()), p, 2);
  }
  ...
  function formatUTCFullYearISO(d, p) {
    var day = d.getUTCDay();
    d = 4 <= day || 0 === day ? (0,_index.utcThursday)(d) : _index.utcThursday.ceil(d);
    return pad(d.getUTCFullYear() % 10000, p, 4);
  }
      ...
      return function(string) {
        ...
        if ("V" in d) {
          ...
          if ("Z" in d) {
            ...
            string = 4 < day || 0 === day ? _index.utcMonday.ceil(string) : (0,_index.utcMonday)(string);
            string = _index.utcDay.offset(string, 7 * (d.V - 1));
            d.y = string.getUTCFullYear();
            d.m = string.getUTCMonth();
            d.d = string.getUTCDate() + (d.w + 6) % 7;
          } else {
            string = localDate(newDate(d.y, 0, 1)), day = string.getDay(), string = 4 < day || 0 === day ? _index.timeMonday.ceil(string) : (0,_index.timeMonday)(string), string = _index.timeDay.offset(string, 7 * (d.V - 1)), d.y = string.getFullYear(), d.m = string.getMonth(), d.d = string.getDate() + (d.w + 6) % 7;
          }
  ...
  var _index = require("module$node_modules$victory_vendor$lib_vendor$d3_time$src$index"), pads = {"-":"", _:" ", 0:"0"}, numberRe = /^\s*\d+/, percentRe = /^%/, requoteRe = /[\\^$*+?|[\]().{}]/g;
};

//# sourceMappingURL=module$node_modules$victory_vendor$lib_vendor$d3_time_format$src$locale.js.map
