...
})).then((function (p__20217){
var vec__20218 = p__20217;
var status = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__20218,(0),null);
var data__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__20218,(1),null);
var G__20221 = status;
var G__20222 = cljs.core.js__GT_clj.cljs$core$IFn$_invoke$arity$variadic(data__$1,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"keywordize-keys","keywordize-keys",1310784252),true], 0));
return (callback.cljs$core$IFn$_invoke$arity$2 ? callback.cljs$core$IFn$_invoke$arity$2(G__20221,G__20222) : callback.call(null, G__20221,G__20222));
...
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div.categories","div.categories",358341752)], null),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__20223_SHARP_){
return (new cljs.core.PersistentVector(null,2,(5),cljs.core.PersistentVector.EMPTY_NODE,[waveney.app.category,p1__20223_SHARP_],null));
...
return new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div.join","div.join",-1216328363),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"h3","h3",2067611163),"Sign up to stay updated"], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"input","input",556931961),new cljs.core.PersistentArrayMap(null, 6, [new cljs.core.Keyword(null,"type","type",1174270348),"email",new cljs.core.Keyword(null,"id","id",-1388402092),"email",new cljs.core.Keyword(null,"name","name",1843675177),"email",new cljs.core.Keyword(null,"value","value",305978217),email,new cljs.core.Keyword(null,"on-change","on-change",-732046149),(function (p1__20224_SHARP_){
return cljs.core.reset_BANG_(waveney.app.email_STAR_,p1__20224_SHARP_.target.value);
...
waveney.app.openweather_api_key = "97da2c69b0746b783f859c90226c3074";
waveney.app.ol_map = (function waveney$app$ol_map(){
return (new shadow.js.shim.module$ol$Map$default(cljs.core.clj__GT_js(new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"layers","layers",1944875032),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [(new shadow.js.shim.module$ol$layer$Tile$default(cljs.core.clj__GT_js(new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"source","source",-433931539),(new shadow.js.shim.module$ol$source$OSM$default())], null)))),(new shadow.js.shim.module$ol$layer$Tile$default(cljs.core.clj__GT_js(new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"source","source",-433931539),(new shadow.js.shim.module$ol$source$XYZ$default(cljs.core.clj__GT_js(new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"url","url",276297046),["https://tile.openweathermap.org/map/precipitation_new/{z}/{x}/{y}.png?appid=",waveney.app.openweather_api_key].join(''),new cljs.core.Keyword(null,"attributions","attributions",1383517818),"&copy; <a href=\"https://openweathermap.org/\">OpenWeatherMap</a>"], null)))),new cljs.core.Keyword(null,"opacity","opacity",397153780),0.7], null))))], null),new cljs.core.Keyword(null,"target","target",253001721),"map",new cljs.core.Keyword(null,"view","view",1247994814),(new shadow.js.shim.module$ol$View$default(cljs.core.clj__GT_js(new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"center","center",-748944368),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [1.2375777300280788,52.468247948753316], null),new cljs.core.Keyword(null,"zoom","zoom",-1827487038),(10),new cljs.core.Keyword(null,"extent","extent",-186399820),new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [0.20094809414538872,52.116568343156075,1.8549922442829825,52.76893220698773], null)], null))))], null))));
});
