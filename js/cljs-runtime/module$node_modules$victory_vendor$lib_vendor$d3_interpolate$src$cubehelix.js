shadow$provide.module$node_modules$victory_vendor$lib_vendor$d3_interpolate$src$cubehelix = function(global, require, module, exports) {
  ...
  var _index = require("module$node_modules$victory_vendor$lib_vendor$d3_color$src$index"), _color = function(obj, nodeInterop) {
  ...
  global = cubehelix(_color.hue);
  exports.default = global;
  global = cubehelix(_color.default);
  exports.cubehelixLong = global;
};

//# sourceMappingURL=module$node_modules$victory_vendor$lib_vendor$d3_interpolate$src$cubehelix.js.map
