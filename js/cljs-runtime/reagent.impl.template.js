...
var G__28225 = o;
reagent.impl.template.goog$module$goog$object.set(G__28225,reagent.impl.template.cached_prop_name(k),(reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null, v)));
...
while (G__28244__i < G__28244__a.length) {G__28244__a[G__28244__i] = arguments[G__28244__i + 0]; ++G__28244__i;}
  args = new cljs.core.IndexedSeq(G__28244__a,0,null);
} 
...
var G__28226 = o;
reagent.impl.template.goog$module$goog$object.set(G__28226,reagent.impl.template.cached_custom_prop_name(k),reagent.impl.template.convert_prop_value(v));
...
while (G__28249__i < G__28249__a.length) {G__28249__a[G__28249__i] = arguments[G__28249__i + 0]; ++G__28249__i;}
  args = new cljs.core.IndexedSeq(G__28249__a,0,null);
} 
return G__28248__delegate.call(this,args);};
G__28248.cljs$lang$maxFixedArity = 0;
G__28248.cljs$lang$applyTo = (function (arglist__28251){
var args = cljs.core.seq(arglist__28251);
...
var G__28227 = props;
var G__28227__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__28227,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__28227);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__28227__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$2(class$,(function (){var or__5002__auto__ = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
...
var props__$1 = reagent.impl.template.set_id_class((function (){var G__28228 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__28228,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$1(class$));
} else {
return G__28228;
}
})(),id_class);
...
var temp__5804__auto___28259 = (function (){var and__5000__auto__ = js_props;
...
if(cljs.core.truth_(temp__5804__auto___28259)){
var d_28260 = temp__5804__auto___28259;
if((d_28260 instanceof reagent.impl.template.UnsafeHTML)){
(js_props.dangerouslySetInnerHTML = ({"__html": d_28260.s}));
} else {
...
var G__28229 = (cljs.core.count(argv) - first_child);
switch (G__28229) {
case (0):
...
var vec__28230 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28230,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28230,(1),null);
var className = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28230,(2),null);
...
var temp__5808__auto___28274 = reagent.impl.util.react_key_from_vec(v);
if((temp__5808__auto___28274 == null)){
} else {
var key_28275 = temp__5808__auto___28274;
(jsprops.key = key_28275);
}
...
var temp__5808__auto___28278 = reagent.impl.util.react_key_from_vec(v);
if((temp__5808__auto___28278 == null)){
} else {
var key_28281 = temp__5808__auto___28278;
(jsprops.key = key_28281);
}
...
var temp__5808__auto___28285 = reagent.impl.util.react_key_from_vec(argv);
if((temp__5808__auto___28285 == null)){
} else {
var key_28286 = temp__5808__auto___28285;
(jsprops.key = key_28286);
}
...
var temp__5808__auto___28293 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5808__auto___28293 == null)){
} else {
var key_28294 = temp__5808__auto___28293;
(jsprops.key = key_28294);
}
...
var temp__5808__auto___28295 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5808__auto___28295 == null)){
} else {
var key_28296 = temp__5808__auto___28295;
(jsprops.key = key_28296);
}
...
return cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__28233_SHARP_){
return reagent.impl.protocols.as_element(compiler,p1__28233_SHARP_);
}),s));
});
...
var ctx = ({});
var vec__28234 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx,compiler);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28234,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28234,(1),null);
...
break;
default:
var G__28308 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
var G__28309 = compiler;
v = G__28308;
compiler = G__28309;
continue;
...
*/
reagent.impl.template.t_reagent$impl$template28240 = (function (opts,id,fn_to_element,parse_fn,meta28241){
this.opts = opts;
this.id = id;
...
(reagent.impl.template.t_reagent$impl$template28240.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_28242,meta28241__$1){
var self__ = this;
var _28242__$1 = this;
return (new reagent.impl.template.t_reagent$impl$template28240(self__.opts,self__.id,self__.fn_to_element,self__.parse_fn,meta28241__$1));
}));

(reagent.impl.template.t_reagent$impl$template28240.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_28242){
var self__ = this;
var _28242__$1 = this;
return self__.meta28241;
}));

(reagent.impl.template.t_reagent$impl$template28240.prototype.reagent$impl$protocols$Compiler$ = cljs.core.PROTOCOL_SENTINEL);

(reagent.impl.template.t_reagent$impl$template28240.prototype.reagent$impl$protocols$Compiler$get_id$arity$1 = (function (this$){
var self__ = this;
var this$__$1 = this;
return self__.id;
}));

(reagent.impl.template.t_reagent$impl$template28240.prototype.reagent$impl$protocols$Compiler$parse_tag$arity$3 = (function (this$,tag_name,tag_value){
var self__ = this;
var this$__$1 = this;
...
(reagent.impl.template.t_reagent$impl$template28240.prototype.reagent$impl$protocols$Compiler$as_element$arity$2 = (function (this$,x){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.as_element(this$__$1,x,self__.fn_to_element);
}));

(reagent.impl.template.t_reagent$impl$template28240.prototype.reagent$impl$protocols$Compiler$make_element$arity$5 = (function (this$,argv,component,jsprops,first_child){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.make_element(this$__$1,argv,component,jsprops,first_child);
}));

(reagent.impl.template.t_reagent$impl$template28240.getBasis = (function (){
return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"opts","opts",1795607228,null),new cljs.core.Symbol(null,"id","id",252129435,null),new cljs.core.Symbol(null,"fn-to-element","fn-to-element",-1764467095,null),new cljs.core.Symbol(null,"parse-fn","parse-fn",-836029424,null),new cljs.core.Symbol(null,"meta28241","meta28241",659406416,null)], null);
}));

(reagent.impl.template.t_reagent$impl$template28240.cljs$lang$type = true);

(reagent.impl.template.t_reagent$impl$template28240.cljs$lang$ctorStr = "reagent.impl.template/t_reagent$impl$template28240");

(reagent.impl.template.t_reagent$impl$template28240.cljs$lang$ctorPrWriter = (function (this__5287__auto__,writer__5288__auto__,opt__5289__auto__){
return cljs.core._write(writer__5288__auto__,"reagent.impl.template/t_reagent$impl$template28240");
}));

/**
 * Positional factory function for reagent.impl.template/t_reagent$impl$template28240.
 */
reagent.impl.template.__GT_t_reagent$impl$template28240 = (function reagent$impl$template$__GT_t_reagent$impl$template28240(opts,id,fn_to_element,parse_fn,meta28241){
return (new reagent.impl.template.t_reagent$impl$template28240(opts,id,fn_to_element,parse_fn,meta28241));
});
...
return (new reagent.impl.template.t_reagent$impl$template28240(opts,id,fn_to_element,parse_fn,cljs.core.PersistentArrayMap.EMPTY));
});
