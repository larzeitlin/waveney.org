shadow$provide.module$node_modules$lodash$_baseOrderBy = function(global, require, module, exports) {
  ...
  module.exports = function(collection, iteratees, orders) {
    ...
    collection = baseMap(collection, function(value, key, collection) {
      return {criteria:arrayMap(iteratees, function(iteratee) {
        return iteratee(value);
      }), index:++index, value};
    });
    return baseSortBy(collection, function(object, other) {
      return compareMultiple(object, other, orders);
    });
  };
};

//# sourceMappingURL=module$node_modules$lodash$_baseOrderBy.js.map
